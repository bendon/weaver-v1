...
from app.api.routes import itineraries, messages, automation, airports, shared_sessions
...
app.include_router(shared_sessions.router, prefix="/api", tags=["Shared Sessions"])  # No /api prefix for /s/ routes
