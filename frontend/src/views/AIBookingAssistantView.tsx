...
import { ArrowLeft, Bot, Plus, BookOpen, Clock, CheckCircle, Filter, Calendar, Tag, MoreVertical, XCircle, AlertCircle, Target, TrendingUp, Sparkles } from 'lucide-react';
