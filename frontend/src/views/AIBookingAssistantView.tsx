...
import { ArrowLeft, Bot, Plus, BookOpen, Clock, CheckCircle, Filter, Calendar, MoreVertical, XCircle, AlertCircle, Target, TrendingUp, Sparkles, MessageSquare, Plane, Hotel, CloudSun, MapPin, FileText } from 'lucide-react';
