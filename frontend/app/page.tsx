...
import '../src/views/LandingView.css';
      ...
      <nav className="landing-nav">
        <div className="nav-container">
          ...
          <div className="nav-actions">
            <button className="nav-btn-secondary" onClick={() => router.push('/login')}>Log in</button>
            <button className="nav-btn-primary" onClick={() => router.push('/traveler')}>Get started</button>
          </div>
          <button
